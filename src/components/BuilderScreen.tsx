...
function PlateSizePanel({ t, plateSpec, setPlateSize }: { t: Translate; plateSpec: CustomBrickSpec; setPlateSize: (lengthMm: number, widthMm: number, thicknessMm: number, flush: boolean) => void }) {
