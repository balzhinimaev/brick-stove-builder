...
describe("plateSeatZ — плита садится на самую высокую полку", () => {
  ...
  it("классическая четверть 32.5 → опора 32.5 (чистая функция; установка пере-режет полку)", () => {
...
describe("колосник садится в вырезы, как плита", () => {
  ...
  it("plateSeatZ над глубокими полками — 32.5 (чистая функция; установка пере-режет)", () => {
