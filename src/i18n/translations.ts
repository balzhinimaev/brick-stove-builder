...
const ru = {
  ...
  plateFlush: "Заподлицо",
  plateFlushHint: "Плита утапливается в вырезы кирпичей: нужен вырез глубиной не меньше толщины плиты по всему её контуру.",
...
const en: Record<TranslationKey, string> = {
  ...
  plateFlush: "Flush",
  plateFlushHint: "The plate sinks into brick cuts: it needs cuts at least as deep as the plate thickness along its contour.",
...
const lt: Record<TranslationKey, string> = {
  ...
  plateFlush: "Lygiai su eile",
  plateFlushHint: "Plokštė įleidžiama į plytų išpjovas: reikia išpjovų, ne seklesnių už plokštės storį.",
